...
namespace IO.Ably.Core.Tests
{
    public class JsonMessageSerializerTests
    {
        ...
        public void DeserializesMessageCorrectly_ConnectionSerial(object connectionSerial)
        {
            ...
            // Assert
            Assert.NotNull(target);
            Assert.Equal<long>(long.Parse(connectionSerial.ToString()), target.ConnectionSerial.Value);
        }
        ...
        public void DeserializesMessageCorrectly_Count(object count)
        {
            ...
            // Assert
            Assert.NotNull(target);
            Assert.Equal<int>(int.Parse(count.ToString()), target.Count.Value);
        }
        ...
        public void DeserializesMessageCorrectly_MsgSerial(object serial)
        {
            ...
            // Assert
            Assert.NotNull(target);
            Assert.Equal<long>(long.Parse(serial.ToString()), target.MsgSerial);
        }
        ...
        public void DeserializesMessageCorrectly_Flags(object flags)
        {
            ...
            // Assert
            Assert.NotNull(target);
            Assert.Equal<byte>(byte.Parse(flags.ToString()), (byte)target.Flags);
        }
